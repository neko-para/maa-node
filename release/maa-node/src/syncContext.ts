...
export class SyncContext {
    ...
    run_task(name: string, param: TaskDecl = {}) {
        return maa.sync_context_run_task(this.handle, name, JSON.stringify(param))
    }

    run_recognition(name: string, image: ImageBuffer, param: TaskDecl = {}) {
    ...
    run_action(name: string, box: maa.Rect, detail: string, param: TaskDecl = {}) {
